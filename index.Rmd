...
- May highlight developmentally-relevant opportunities in the environment
    ...
    - Shifting associations via changes in what someone rewarding

## Measuring social motives in the lab

- Goal: create behavioral task to measure social motives
- Using the effect of salience on learning
...
- During adolescence, information relevant to social motivations should be more salient and so should be learned more quickly
...
Drawn from ongoing longitudinal study (TDS) and SONA
...
- Bayesian analysis and interpretation of posterior densities
